...
var globe_Atmosphere = function(innerRadius,outerRadius) {
	...
	var atmosphereOuterMaterial = new globe_AtmosphereOuterMaterial({ uniforms : uniforms, defines : defines});
	...
	var atmosphereInnerMaterial = new globe_AtmosphereInnerMaterial({ uniforms : uniforms, defines : defines});
...
var globe_Globe = function(radius) {
	...
	var globeMat = new globe_GlobeMaterial({ map : colorTex, bumpMap : bumpTex, bumpScale : 0.0025 * radius, specularMap : specTex, specular : new THREE.Color(3355443), shininess : 25, wireframe : false});
...
globe_AtmosphereInnerMaterial.fragmentShaderStr = "//\n// Atmospheric scattering fragment shader\n//\n// Author: Sean O'Neil\n//\n// Copyright (c) 2004 Sean O'Neil\n//\n\n#ifdef GROUND_TEXTURES\nuniform sampler2D s2Tex1;\nuniform sampler2D s2Tex2;\nvarying vec2 vUv;\n#endif\n\nvarying vec4 secondaryColor;\nvarying vec4 frontColor;\n\n\nvoid main (void)\n{\n\t#ifdef GROUND_TEXTURES\n\tgl_FragColor = frontColor + texture2D(s2Tex1, vUv) * texture2D(s2Tex2, vUv) * secondaryColor;\n\t#else\n\tgl_FragColor = frontColor + 0.25 * secondaryColor;\n\t#endif\n}\n";
